...
async def test_echo_timing_uses_mic1_window(dut):
    ...
    # Reset: hold rst_n low, ui_in = 0 (restart=0, mic_pdm=0, unused=0)
    dut.rst_n.value = 0
    dut.ui_in.value = 0
    ...
    # Feed PDM bits: mic_pdm is mapped to ui_in[1], restart (ui_in[0]) stays low
    ...
    # Reconstruct outputs from dedicated and bidirectional pins
